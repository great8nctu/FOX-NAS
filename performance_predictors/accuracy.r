...
acc_model <- lm(formula = my_data$acc ~ 
                      ...
                      +my_data$tot_e_24+my_data$tot_e_40+my_data$tot_e_80+my_data$tot_e_112+my_data$tot_e_160

                      +my_data$tot_e_24*my_data$tot_24
                      +my_data$tot_e_40*my_data$tot_40
                      +my_data$tot_e_80*my_data$tot_80
                      +my_data$tot_e_112*my_data$tot_112
                      +my_data$tot_e_160*my_data$tot_160
